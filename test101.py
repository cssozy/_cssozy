...
print(item)
print(item.get_text())#content_table > div.table_group > div:nth-child(3) > div.item_detail > a > strong
...
iss = res_html.selcts("a.wrap_thumb")
#print(iss)
...
import requests as rq
import os
from urllib.request import urletrieve as rl
...
print("\n---------------------------\n)")
sv = s1.sort_values(ascending=False)
print(sv1)
 """
